  ...
  void init() {
    ...
    scenarios.insert({ "u pattern - steal territory", {
      ...
      expectation{
          ...
          position{ 29, 1 },
          alive{ 33 },
          scores{ 9, 18, 27, 36, 45, 54, 63, 72, 81, 90, 99, 108, 117, 177, 201, 225, 249, 272, 294, 315, 335, 354, 373, 392, 411, 427, 443, 459, 475, 491, 507, 523, 593  },
          trail_pos{},
          region_pos{ position{ 5, 1 }, position{ 5, 2 }, position{ 5, 3 },
                      position{ 6, 1 }, position{ 6, 2 }, position{ 6, 3 }, 
                      position{ 7, 1 }, position{ 7, 2 }, position{ 7, 3 },
                      position{ 8, 1 }, position{ 8, 2 }, position{ 8, 3 },
